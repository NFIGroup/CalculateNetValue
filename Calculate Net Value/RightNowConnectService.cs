...
namespace Calculate_Net_Value
{
    class RightNowConnectService
    {
        ...
        public string[] GetOther(string ID)
        {
            ...
            string query = "SELECT o.other_charges_amount_adj FROM CO.OtherCharges o WHERE INCIDENT = " + ID;

           //   MessageBox.Show(query);
            string[] resultSet = GetRNData("Other", query);
        ...
        public string[] GetLabor(string ID)
        {

            string query = "SELECT l.labor_rate_adj, l.labor_hrs_adj FROM CO.Labor l WHERE INCIDENT = " + ID;

            //  MessageBox.Show(query);
            string[] resultSet = GetRNData("Labor", query);
        ...
        public string[] GetParts(string ID)
        {
            List<string> regions = new List<string>();
            
            string query = "SELECT p.parts_cost_adj_org, p.part_price_adj, p.qty FROM CO.Parts p WHERE INCIDENT = " + ID;

          //  MessageBox.Show(query);
            string[] resultSet = GetRNData("Parts", query);
        ...
        /// <param name="val"></param>
        /// <returns> DataValue</returns>
        public DataValue createIntegerDataValue(int val)
        {
            DataValue dv = new DataValue();
            dv.Items = new Object[] { val };
        ...
        /// <returns> DataValue</returns>
        public DataValue createNamedIDDataValue(long idVal)
        {
            ID id = new ID();
            id.id = idVal;
            id.idSpecified = true;
